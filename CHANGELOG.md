...
- Progress indicator on the active playlist in the Playlists list while syncing

### Changed

- Disable all playlist Sync buttons while any sync is running
- Disable Sync for playlists that are not selected

## [1.3.0] - 2026-07-10

### Added

- Overall playlist progress on the Sync page when syncing multiple playlists (Playlist N of M), alongside per-playlist track progress
